...
class TokenTypeTrees {
  static TypeTree arg0(TypeCapture capture) =>
      capture.consumeType(TypeTree.terminal);
  static TypeTree arg1(TypeCapture base, TypeCapture arg0) =>
      TypeContainers.arg2(base, arg0).consume(TypeTree.arg1);
  static TypeTree arg2(TypeCapture base, TypeCapture arg0, TypeCapture arg1) =>
      TypeContainers.arg3(base, arg0, arg1).consume(TypeTree.arg2);
  static TypeTree arg3(TypeCapture base, TypeCapture arg0, TypeCapture arg1,
          TypeCapture arg2) =>
      TypeContainers.arg4(base, arg0, arg1, arg2).consume(TypeTree.arg3);
}
...
abstract class TypeTree<BASE> {
  ...
  static TypeTree argN<BASE>(List<TypeTree> arguments) =>
      TypeTreeN<BASE>(arguments);
  ...
  static String $toString(TypeTree tree) {
    if (tree.arguments.isEmpty) {
      ...
      var diamondlessBaseName =
          tree.base.typeArgument.toString().split("<").first;
  ...
  static int $hashCode(TypeTree tree) {
    ...
    return tree.base.typeArgument.hashCode ^
        tree.arguments.map((e) => e.hashCode).reduce((a, b) => a ^ b);
  }
}
...
class TypeTree3<BASE, ITEM0, ITEM1, ITEM2> extends TypeTree<BASE> {
  ...
  @override
  List<TypeTree> get arguments =>
      [TypeTree0<ITEM0>(), TypeTree0<ITEM1>(), TypeTree0<ITEM2>()];
